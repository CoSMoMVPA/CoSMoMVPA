...
%
% There are 10 runs with 6 volumes per run. The runs are vertically stacked on
% above the other. The six volume in each run correspond to the stimuli:
% 'monkey','lemur','mallard','warbler','ladybug','lunamoth'. Add numeric samples
% such that 1 corresponds to 'monkey', 2 corresponds to 'lemur', etc. Then add
% numeric chunk attributes so that 1 corresponds to run1, 2 corresponds to run2,
% etc.
