...
samples based on which is nearest (where 'nearest', for now, is defined based on Euclidean distance). Test your classifiers on pairwise or multi-class datasets.
