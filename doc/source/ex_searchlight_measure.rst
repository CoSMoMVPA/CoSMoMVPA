...
In this exercise we bring the generic :ref:`cosmo_cross_validation_accuracy_measure` and :ref:`cosmo_searchlight` functions together, by applying the measure to each searchlight location.
