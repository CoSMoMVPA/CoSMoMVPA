...
project = "CoSMo Multivariate Pattern Analysis toolbox"
copyright = "2013-2014, Nikolaas N. Oosterhof and Andrew C. Connolly"
...
html_static_path = ["_static", "cosmomvpa.github.io"]
...
latex_documents = [
    (
        ...
        "Nikolaas N. Oosterhof and Andrew C. Connolly",
        "manual",
    ),
]
...
man_pages = [
    (
        "index",
        "cosmo",
        "CoSMo Multivariate Pattern Analysis toolbox",
        ["Nikolaas N. Oosterhof and Andrew C. Connolly"],
        1,
    )
]
...
texinfo_documents = [
    (
        "index",
        "Cosmo",
        "CoSMo Multivarate Pattern Analysis Workshop",
        "Nikolaas N. Oosterhof and Andrew C. Connolly",
        "Cosmo",
...
datadb_url = "https://github.com/CoSMoMVPA/CoSMoMVPA/releases/latest/download/"
# datadb_url=''
...
extlinks = {
    ...
    "demo": ("_static/publish/%s.html", "Matlab output: %s"),
